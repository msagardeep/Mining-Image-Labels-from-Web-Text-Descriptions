...
% example usage -- [closestMatches] = get_c_g_brown('/Users/tlberg/Desktop/teaching/Fall_12/hw/hw1/images/');

function [closestMatches] = get_c_g_brown(databaseDirectory)
...
model1 = svmtrain(blk_trng_lbl_vect_70,hsv_hist_train_70,'-c 990 -g 0.01 -b 1');

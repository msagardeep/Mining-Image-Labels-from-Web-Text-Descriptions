...
% example usage -- [closestMatches] = get_c_g_silver('/Users/tlberg/Desktop/teaching/Fall_12/hw/hw1/images/');

function [closestMatches] = get_c_g_silver(databaseDirectory)
...
model1 = svmtrain(blk_trng_lbl_vect_70,hsv_hist_train_70,'-c 800 -g 600 -b 1');
